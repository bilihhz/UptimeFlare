...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://hhz114514.qzz.io/', label: '博客' },
    { link: 'https://github.com/bilihhz', label: 'GitHub' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: 'hhz-blog',
      method: 'HEAD',
      target: 'https://hhz114514.qzz.io/',
      statusPageLink: 'https://hhz114514.qzz.io/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
